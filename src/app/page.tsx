...
const LINKS = [
  ...
  },
  {
    href: "/swap",
    title: "調堂安排",
    desc: "病假／事假／公假多日調堂；可即時揀建議。CLP 可調；同一科兩堂可一拼，但同一班當日同一科不能 4 堂或以上；普通話／戲劇、英文對拆堂由另一位老師合班（不計節數）；可複合多名老師；課室不能同時兩班。",
    icon: ArrowLeftRight,
  },
  {
    href: "/cover",
    title: "代堂編配",
    desc: "勾選請假同事並標明病假／事假／公假；公假不計 ±。普通話／戲劇、英文對拆堂由另一位老師合班，不計節數。按負數結餘優先組當日代堂方案。",
    icon: Repeat2,
  },
  {
